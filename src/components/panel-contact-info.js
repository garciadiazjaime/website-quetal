                    ...
                    <Col xs={12} sm={6} id="disaster">
                        ...
                        <ul>
                            <li>
                                ...
                                <a href="tel:52708888" className="tel">5270.8888</a>
                            </li>
                            <li>
                                Del Interior de la República
                                <a href="tel:018004727696" className="tel">01800.GS.APOYO <span className="telMeaning">47.27696</span></a>
                            </li>
                            <li>
                                Asistencia en Viajes y Auxilio Vial en el Distrito Federal e Interior del País, marque sin costo
                                <a href="tel:018004729832" className="tel">01800.GS.AYUDA <span className="telMeaning">47.29832</span></a>
                            </li>
                        </ul>
                    </Col>
